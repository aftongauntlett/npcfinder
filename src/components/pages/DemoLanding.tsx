              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  <div
                    ...
                    style={{ backgroundColor: withOpacity(arch.iconColor, 0.125) }}
                  >
                    <arch.icon
                      className="w-6 h-6"
        ...
        >
          <div className="mb-12">
            ...
            <div
              ...
              style={{
                background: `linear-gradient(to right, ${withOpacity(LANDING_TEAL, 0.051)}, transparent)`,
                borderLeft: `2px solid ${withOpacity(LANDING_TEAL, 0.502)}`,
              }}
            >
            ...
            <div className="flex flex-col items-center gap-3">
              <div
                ...
                style={{
                  ...
                  borderWidth: "1px",
                  borderStyle: "solid",
                  borderColor: withOpacity(LANDING_PEACH, 0.188),
                }}
              >
                <svg
                  className="w-7 h-7"
