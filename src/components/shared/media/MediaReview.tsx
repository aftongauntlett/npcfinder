    ...
    <div className={className}>
      ...
      <div className="pb-5">
        ...
        <div className="space-y-3.5">
          {/* Rating */}
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 mt-0">
              Rating
            </label>
            <StarRating
              rating={rating}
          ...
          <div>
            ...
            >
              Your Thoughts <span className="text-gray-400">(optional)</span>
            </label>
            <textarea
              id="review-text"
              value={reviewText}
              ...
              rows={6}
              className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary resize-none placeholder:text-gray-400 dark:placeholder:text-gray-500"
            />
          </div>
          ...
          {isPublic && (
            <div className="flex items-start gap-2 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg mb-0">
