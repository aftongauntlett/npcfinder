        ...
        {(!filterConfig || filterConfig.type === "chips") && sortConfig && (
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-1.5 rounded-lg border-2 border-primary/20 bg-surface text-primary font-medium cursor-pointer hover:border-primary/40 transition-colors"
            >
