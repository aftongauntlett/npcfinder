...
const Tabs: React.FC<TabsProps> = ({
  ...
  return (
    <>
      ...
      {/* Desktop Tabs */}
      <div className="hidden sm:flex items-end justify-between gap-3 border-b border-gray-200 dark:border-gray-700 -mb-px">
        <nav
        ...
        {rightActions && (
          <div className="flex items-center pb-2.5 flex-shrink-0">
            {rightActions}
          </div>
        )}
      </div>
...
const MobileTabSelector = React.memo<MobileTabSelectorProps>(
  ({ tabs, activeTabId, onTabChange, ariaLabel, rightActions }) => {
