...
export const FutureFeatureCard: React.FC<FutureFeatureCardProps> = ({
  ...
  if (isBigDream) {
    return (
      <div className="border border-teal-400/20 rounded-2xl p-8 bg-slate-800/40 hover:border-teal-400/40 hover:bg-slate-800/60 transition-all duration-300 cursor-default">
